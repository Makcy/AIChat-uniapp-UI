  ...
  data() {
    return {
      ...
      messages: [
        ...
        { role: 'assistant', content: '你好！有什么我可以帮助你的吗？', time: Date.now() },
        { role: 'user', content: '我想知道健康饮食的建议', time: Date.now() },
        { role: 'assistant', content: '当然可以！您可以咨询我关于健康饮食的建议。', time: Date.now() },
